...
if os.environ.get("OPENAI_API_KEY") and os.environ.get("DEEPSEEK_API_KEY") and os.environ.get("GOOGLE_API_KEY") and os.environ.get("LLAMA_API_KEY"):
    ...
    if st.button("Get Answer"):
        if not query:
            ...
            # The following block for generating the primary answer is now commented out.
            ...
            # The following block for querying multiple models and showing the aggregated answer is also commented out.
            ...
            with st.spinner("Refining aggregated answer..."):
                # Note: Even though the aggregated answer is not printed,
                # it is used to generate the refined answer.
                refined = chatbot.refine("")  # Pass an empty string or aggregated result if needed
